...
; (function ($, window, document, undefined) {
    ...
    var pluginName = "mgGlitch",
      defaults = {
        ...
        blend: true,
        blendModeType: 'hue',
        glitch1LeftMaxValue: 16,
        glitch1RightMaxValue: 16,
        glitch1TimeMin: 600,
        glitch1TimeMax: 900,
        glitch2TimeMin: 10,
        glitch2TimeMax: 115,
    ...
    $.extend(Plugin.prototype, {
      ...
      glitch: function () {
        ...
        // random values for glitch elem : left and right
        var glitch1LeftMaxValue = this.settings.glitch1LeftMaxValue;
        var glitch1RightMaxValue = this.settings.glitch1RightMaxValue;
        ...
        function glitch1() {
          ...
          var clipPos1 = getRandomInt(10, 700);
          var clipPos2 = 9999;
          var clipPos3 = getRandomInt(10, 600);
          var clipPos4 = 0;
          var leftValue = getRandomInt(0, glitch1LeftMaxValue);
          var rightValue = getRandomInt(0, glitch1RightMaxValue);
