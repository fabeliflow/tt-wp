...
<!-- mgGlitch -->
<script src="<?php echo get_template_directory_uri(); ?>/vendor/mg-glitch/mgGlitch.min.js"></script>
...
<!-- About JS -->
<script src="<?php echo get_template_directory_uri(); ?>/js/minified/about.min.js"></script>
